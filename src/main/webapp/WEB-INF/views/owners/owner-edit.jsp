...
<h1>Edit Owner page</h1>
    ...
    <form:form method="POST" commandName="ownerObject" action="${pageContext.request.contextPath}/owners/edit/${ownerObject.id}.html" class="form-horizontal" >
<fieldset>
    <legend>Edit Owner Infos</legend>
